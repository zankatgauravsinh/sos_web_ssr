...
@Component({
  ...
  imports: [CommonModule, CurrencySymbolPipe, TranslateModule,
    ButtonComponent, NgbTooltip],
  templateUrl: './product-box-variant-attributes.component.html',
  styleUrl: './product-box-variant-attributes.component.scss'
})
export class ProductBoxVariantAttributesComponent {
